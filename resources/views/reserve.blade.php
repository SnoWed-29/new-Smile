@extends('layouts.app')
@section('content')
    <div class="container w-9/12 mx-auto mt-14 bg-white shadow-xl p-4">
...
<form method="POST" action="/rendez-vous" >
    ...
    <div class="flex h-64 my-2 relative">
        <textarea name="message" style="resize: none;" class="w-full border-2 border-grey-500 onfocus:border-2 onfocus:border-[#3bbadc] h-full transition-transform duration-300 transform placeholder-opacity-0 focus:placeholder-opacity-100" placeholder="Message..." required></textarea>
      </div>
